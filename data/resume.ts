export const summary =
  "Resourceful Full Stack Developer with \
   experience delivering performant web apps \
   for varied industries. Expert in React, Next.js, \
   Django, and modern DevOps tools. Passionate about \
    building delightful user experiences and driving business value with technology.";
